...
<template>
  <div
    class="font-avenir text-primary-700 border-primary-200 bg-primary-50 relative z-50 flex w-full max-w-xs cursor-default items-center overflow-hidden rounded-lg border p-3 shadow-xl"
