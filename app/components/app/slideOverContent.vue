...
<template>
  <div
    ...
    <div
      class="bg-primary-800 absolute top-8 -left-6 z-20 flex h-12 w-12 cursor-pointer items-center justify-center rounded-xl duration-300 hover:scale-105 hover:shadow-lg dark:bg-gray-600"
      @click="props.closeSideModal()">
      <Icon name="lucide:x" size="20" class="text-gray-50" />
    </div>
