...
// Quantités par article (keyed by numero_symbole)
  ...
  <div class="flex h-full w-80 flex-none flex-col border-l border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-900">
    ...
    <div class="border-b border-gray-200 px-4 py-4 dark:border-gray-700">
      <div class="mb-3 flex items-center gap-2">
        ...
        <div>
          <h2 class="text-sm font-semibold text-gray-800 dark:text-white">Catalogue matières</h2>
          <p class="text-xs text-gray-400">SNCF Réseau 2026</p>
        </div>
      </div>
      <!-- Search -->
      <div class="relative">
