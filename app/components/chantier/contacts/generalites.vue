        ...
        <table class="w-full text-left text-sm">
          ...
          <tbody>
            ...
            <tr v-if="contactsGeneralites?.coordinateur_securite_nom" class="border-primary-100 border-b">
              ...
              <td class="text-primary-700 px-2 py-1.5">
                <a v-if="contactsGeneralites?.coordinateur_securite_email"
                  :href="`mailto:${contactsGeneralites.coordinateur_securite_email}`" class="hover:underline">
      ...
      <template #default>
        <form @submit.prevent="saveGeneralites" class="space-y-6">
          ...
          <div class="space-y-4">
            ...
            <AppInput v-model="editFormGeneralites.coordinateur_securite_nom" name="coordinateur_securite_nom"
              title="Nom" placeholder="Nom du coordinateur" />
            <AppInput v-model="editFormGeneralites.coordinateur_securite_email" name="coordinateur_securite_email"
