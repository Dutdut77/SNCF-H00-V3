...
const openEditEtudes = () => {
  editFormEtudes.value = {
    ...
    cdpe_nom: contactsEtudes.value?.cdpe_nom || '',
    cdpe_email: contactsEtudes.value?.cdpe_email || '',
    eg_nom: contactsEtudes.value?.eg_nom || '',
    eg_email: contactsEtudes.value?.eg_email || ''
  }
