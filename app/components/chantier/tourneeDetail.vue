...
// Fil chronologique mixte notes + photos
  ...
  <Teleport to="body">
              ...
              <div v-if="item._kind === 'note'" class="flex items-start gap-3">
                ...
                <div class="min-w-0 flex-1">
                  <div class="rounded-xl bg-white p-3 shadow-sm dark:bg-gray-800">
                    <p class="whitespace-pre-wrap text-sm text-gray-800 dark:text-white">{{ item.content }}</p>
                  </div>
    ...
    <AppModal v-model="showDeleteConfirm" size="sm">
      ...
      <p class="text-sm text-gray-600 dark:text-gray-400">
        Toutes les notes et photos de cette tournée seront définitivement supprimées.
