/**
 * Schema du template "Paysage Vertical"
 * 
...
export const paysageVerticalSchema: TemplateSchema = {
  templateKey: 'paysage-vertical',
  name: 'Paysage Vertical',
  description: 'Format A4 paysage avec titre, textes et images empilés verticalement',
