...
const toneMap = {
  primary: {
    ...
    badge:
      'bg-primary-500/10 text-primary-600 border-primary-500/20 dark:bg-primary-500/10 dark:text-primary-200 dark:border-primary-500/30'
  },
  amber: {
    icon: 'bg-amber-500/10 text-amber-500 ring-amber-500/20',
    badge:
      'bg-amber-500/10 text-amber-700 border-amber-500/20 dark:bg-amber-500/10 dark:text-amber-200 dark:border-amber-500/30'
  },
  emerald: {
    icon: 'bg-emerald-500/10 text-emerald-500 ring-emerald-500/20',
    badge:
      'bg-emerald-500/10 text-emerald-700 border-emerald-500/20 dark:bg-emerald-500/10 dark:text-emerald-200 dark:border-emerald-500/30'
  },
  sky: {
  ...
  violet: {
    ...
    badge:
      'bg-violet-500/10 text-violet-700 border-violet-500/20 dark:bg-violet-500/10 dark:text-violet-200 dark:border-violet-500/30'
  }
}
  ...
  <div class="flex flex-col gap-4 h-full overflow-auto p-4 w-full">
    <div class="flex flex-col gap-5">
      ...
      <div class="flex flex-wrap items-center gap-3">
        ...
        <span class="text-primary-600 text-xs">Sauvegarde automatique après 5 secondes d’inactivité.</span>
      </div>
    </div>
