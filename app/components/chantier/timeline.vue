...
<template>
  <div class="space-y-4">
    ...
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-800 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-slate-900 focus:ring-2 focus:ring-slate-500 focus:outline-none active:scale-[0.98]">
      Valider
    </button>
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-100 px-5 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-200 focus:ring-2 focus:ring-slate-300 focus:outline-none active:scale-[0.98]">
      Annuler
    </button>
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg bg-red-700 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-red-800 focus:ring-2 focus:ring-red-500 focus:outline-none active:scale-[0.98]">
      Supprimer
    </button>
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-900 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-black focus:ring-2 focus:ring-slate-600 focus:outline-none active:scale-[0.98]">
      Supprimer
    </button>
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg bg-slate-900 px-5 py-2.5 text-sm font-semibold text-red-600 transition hover:bg-black hover:text-red-500 focus:ring-2 focus:ring-slate-600 focus:outline-none active:scale-[0.98]">
      Supprimer
    </button>
    <button
      class="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 px-5 py-2.5 text-sm font-semibold text-slate-700 transition hover:bg-slate-100 focus:ring-2 focus:ring-slate-400 focus:outline-none active:scale-[0.98]">
      Supprimer
    </button>
    <!-- Timeline verticale -->
