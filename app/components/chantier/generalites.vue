  ...
  <div class="space-y-4">
    ...
    <div class="flex flex-col lg:flex-row gap-4 items-center justify-between">
      <AppTitleMain
        ...
        description="Données principales du chantier"
      />
      <AppButtonValidated
        type="button"
        theme="primary"
    ...
    <div
      class="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-100 dark:border-gray-700"
    >
      <div class="p-6">
        <div class="flex items-center gap-3 mb-6">
          <div
            class="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-blue-100 to-indigo-200 dark:from-blue-900/50 dark:to-indigo-800/50"
          >
            <Icon
        ...
        <div class="relative py-2">
          ...
          <div
            class="absolute left-[70px] right-[70px] top-1/2 -translate-y-1/2 h-1 rounded-full bg-linear-to-r from-blue-400 to-indigo-500 shadow-sm z-0"
          ></div>

          <div class="flex items-center w-full relative">
            <!-- Point de début -->
            <div
              class="flex flex-col items-center min-w-[70px] z-10 bg-white dark:bg-gray-800"
            >
              <div
                class="px-2 py-1 rounded-lg bg-blue-100 dark:bg-blue-900/40 mb-2"
              >
                <span
              ...
              <div class="relative">
                <div
                  class="w-4 h-4 rounded-full bg-blue-500 shadow-lg shadow-blue-500/40"
                ></div>
                <div
                  class="absolute inset-0 w-4 h-4 rounded-full bg-blue-400 animate-ping opacity-20"
                ></div>
              </div>
              <span
                class="text-xs font-semibold text-gray-800 dark:text-gray-200 mt-2"
              >
            ...
            >
              ...
              >
                ...
                <div class="px-1.5 py-0.5 mb-1">
                  <span
                    class="text-xs font-bold text-orange-700 dark:text-orange-400 whitespace-nowrap"
                  >
                ...
                <div
                  class="w-1 h-10 bg-orange-500 dark:bg-orange-400 rounded-full shadow-md relative"
                >
                  <!-- Petit point au milieu pour marquer la timeline -->
                  <div
                    class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-2.5 h-2.5 rounded-full bg-orange-500 dark:bg-orange-400 border-2 border-white dark:border-gray-800 shadow-sm"
                  ></div>
                </div>
            ...
            >
              <div
                class="px-2 py-1 rounded-lg bg-indigo-100 dark:bg-indigo-900/40 mb-2"
              >
                <span
                  class="text-xs font-bold text-indigo-700 dark:text-indigo-400"
                >
              ...
              <div class="relative">
                <div
                  class="w-4 h-4 rounded-full bg-indigo-500 shadow-lg shadow-indigo-500/40"
                ></div>
              </div>
              <span
                class="text-xs font-semibold text-gray-800 dark:text-gray-200 mt-2"
        ...
        >
          ...
          <div class="flex flex-wrap gap-2">
            ...
            >
              ...
              S{{ weekend.semaine_debut }}/{{ weekend.annee_debut }} → S{{
                weekend.semaine_fin
              }}/{{ weekend.annee_fin }}
            </div>
          </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      >
        <div class="p-5">
          <div class="flex items-center gap-3 mb-4">
            <div
              class="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-slate-100 to-slate-200 dark:from-slate-800 dark:to-slate-700"
            >
              <Icon
                name="lucide:scale"
                size="20"
      ...
      >
        <div class="p-5">
          <div class="flex items-center gap-3 mb-4">
            <div
              class="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-indigo-100 to-violet-200 dark:from-indigo-900/50 dark:to-violet-800/50"
            >
              <Icon
          ...
          <p class="text-xl font-bold text-gray-900 dark:text-white">
            {{
              chantier.type_essais
                ? chantier.type_essais === "simple"
                  ? "Simple"
                  : "Complexe"
                : "-"
            }}
      ...
      <div class="p-6">
        <div class="flex items-center justify-between">
          <div class="flex items-center gap-3">
            <div
              class="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-amber-100 to-orange-200 dark:from-amber-900/50 dark:to-orange-800/50"
            >
              <Icon
                name="lucide:package"
                size="20"
    ...
    >
      <div class="p-6">
        <div class="flex items-center gap-3 mb-5">
          <div
            class="flex items-center justify-center w-10 h-10 rounded-xl bg-linear-to-br from-cyan-100 to-teal-200 dark:from-cyan-900/50 dark:to-teal-800/50"
          >
            <Icon
              name="lucide:wallet"
              size="20"
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
              Références comptables du chantier
            </p>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            <label
              class="text-xs font-semibold text-cyan-600 dark:text-cyan-400 uppercase tracking-wider"
              >Compte MOE</label
            >
            <p
              class="mt-2 text-lg font-bold text-gray-900 dark:text-white font-mono"
            >
              {{ chantier.compte_moe || "-" }}
            </p>
          </div>
    ...
    >
      <div class="p-6">
        ...
        <div
          v-else
          class="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-4 border border-gray-100 dark:border-gray-600 text-center"
        >
          <Icon
            name="lucide:file-x"
            size="32"
    ...
    <AppSlideOver
      :sideModal="showEditSlideOver"
      :closeSideModal="closeEditSlideOver"
    >
      <AppSlideOverContent
        v-if="showEditSlideOver"
        :closeSideModal="closeEditSlideOver"
      >
        <template #header>
        ...
        <template #default>
          <form @submit.prevent="saveChanges" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div v-if="weekends.length > 0" class="space-y-2">
                ...
                >
                  <div class="flex items-center gap-2">
                    ...
                    >
                      S{{ weekend.semaine_debut }}/{{ weekend.annee_debut }} →
                      S{{ weekend.semaine_fin }}/{{ weekend.annee_fin }}
                    </span>
                  </div>
                  <button
                    type="button"
              ...
              >
                ...
                <AppButtonValidated
                  ...
                  theme="secondary"
                  :validated="
                    !!newWeekend.semaineDebut && !!newWeekend.semaineFin
                  "
            ...
            <div class="space-y-4">
              ...
              <div class="w-full">
                <label for="autre" class="block text-sm mb-0.5"
