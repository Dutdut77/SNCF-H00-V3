      ...
      <div class="p-6">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">{{ sortedPlans.length }} plan{{ sortedPlans.length > 1 ? 's' : '' }}</p>
          </div>
        </div>
        ...
        <div v-if="sortedPlans.length > 0" class="space-y-3">
          <div 
            ...
            :class="getCardClasses(getPtStatus(plan).status)"
        ...
        <div v-else class="text-center py-12">
          <div class="relative inline-block">
            <div class="absolute inset-0 bg-linear-to-br from-sky-200 to-blue-200 dark:from-sky-900/30 dark:to-blue-900/30 rounded-full blur-2xl opacity-50"></div>
