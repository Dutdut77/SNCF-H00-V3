      ...
      <div class="p-6">
        <div class="flex items-center gap-3 mb-6">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">{{ sortedDocuments.length }} document{{ sortedDocuments.length > 1 ? 's' : '' }}</p>
          </div>
        </div>
        ...
        <div v-if="sortedDocuments.length > 0" class="space-y-3">
          <div 
            ...
            :class="getCardClasses(getDocumentStatus(doc, true).status)"
        ...
        <div v-else class="text-center py-12">
          <div class="relative inline-block">
            <div class="absolute inset-0 bg-linear-to-br from-indigo-200 to-purple-200 dark:from-indigo-900/30 dark:to-purple-900/30 rounded-full blur-2xl opacity-50"></div>
          ...
          <form @submit.prevent="handleSave" class="space-y-6">
            ...
            <div class="space-y-4">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div v-if="form.date_mes" class="flex flex-col">
                  <label class="block text-sm mb-0.5 text-red-600 dark:text-red-400 font-medium">Date RC (calculée)</label>
                  <div class="flex items-center gap-2 px-3 py-2 rounded-md bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Dates prévues</h3>
              </div>
              
              <!-- Liste des dates prévues -->
              <div v-if="form.date_prevu.length > 0" class="flex flex-wrap gap-2">
                <div 
                  v-for="(dateP, idx) in form.date_prevu" 
                  :key="idx"
            ...
            <div class="space-y-4">
              <div class="flex items-center gap-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <h3 class="text-sm font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Observation</h3>
              </div>
