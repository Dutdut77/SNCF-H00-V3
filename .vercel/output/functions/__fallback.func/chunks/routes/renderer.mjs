...
import { i as buildAssetsURL, u as useRuntimeConfig, j as getResponseStatusText, k as getResponseStatus, l as defineRenderHandler, p as publicAssetsURL, g as getQuery, c as createError, m as destr, n as getRouteRules, o as relative, q as joinURL, t as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/svg+xml","href":"/favicon.png"}],"style":[],"script":[],"noscript":[]};
...
const entryFileName = "BEv78egS.js";
